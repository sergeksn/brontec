...
let slider = qs('.glavnaya-9__wrap-slider>.swiper'), //элемент слайдера
    CONTROLLER = {
        ...
        init_swiper: function () {
            this.swiper = new Swiper(slider, {
                modules: [Navigation],
                navigation: {
                    nextEl: '.glavnaya-9__control-buttons-button-next',
                    prevEl: '.glavnaya-9__control-buttons-button-prev',
                },
                on: {
                    afterInit: function () {
