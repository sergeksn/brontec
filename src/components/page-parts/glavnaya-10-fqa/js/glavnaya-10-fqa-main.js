...
qsa('.glavnaya-10__fqa-wrap>div').forEach(spoilers_wrap => {
    let spoiler_content_wrap = qs('.glavnaya-10__fqa-wrap-spoiler-wrap', spoilers_wrap),
        ...
        rotate_arrow = () => title_icon.classList.toggle('glavnaya-10__fqa-wrap-spoiler-title-text-toggle-icon--open'); //при скрытии/показе спойлера переключаем класс, чтоб менялся поворот крестика
