...
let cart = qs('.cart'),
    ...
    CONTROLER = {
        init: function () {
            ...
            this.update_order_product_spoilers(); //функция подключает спойлеры к кадому блоку сотава товаров в заказе
        ...
        //функция подключает спойлеры к кадому блоку сотава товаров в заказе
