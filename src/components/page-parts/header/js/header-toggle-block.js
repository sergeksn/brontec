...
import Header_Search_Block from "./header-search";
import Scroll_To_Top_Button from "@scroll-to-top-button-main-js";
import { Header_Overlay } from "@js-moduls/overlays";
...
export default new (class {
    ...
    async close_block() {
        ...
        let header_scrollbar_height_lower = anime({
            ...
            up_hidden_header_part = anime({
                //скрываем открывающийся блок хедера понимая его вверх
                targets: this.hidden_header_part[0],
