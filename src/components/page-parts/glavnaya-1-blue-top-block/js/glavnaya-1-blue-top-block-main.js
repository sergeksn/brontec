...
let slider = qs('.glavnaya-1__second-part-marki-slider-swiper'), //элемент слайдера
    CONTROLLER = {
        ...
        autoplay_delay: 2000, //пауза между автопереключениями слайдера
        ...
        init_swiper: function () {
            ...
            this.swiper = new Swiper(slider, {
                ...
                navigation: {
                    nextEl: '.glavnaya-1__second-part-marki-slider-control-buttons-button-next',
                    prevEl: '.glavnaya-1__second-part-marki-slider-control-buttons-button-prev',
                },
                on: {
                    afterInit: function () {
