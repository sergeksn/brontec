...
let slider = qs('.slider-full-width-page__wrap-slider-swiper-wrap>.swiper'), //элемент слайдера
    toggler = qs('.slider-full-width-page__toggler'), //блок с меняющимся текстом
    text_wrap = qs('.slider-full-width-page__toggler-text-wrap'), //текстовая оболочка для текста активного слайда
    CONTROLLER = {
        ...
        init_swiper: function () {
            ...
            this.swiper = new Swiper(slider, {
                modules: [Navigation],
                navigation: {
                    nextEl: '.slider-full-width-page__control-buttons-button-next',
                    prevEl: '.slider-full-width-page__control-buttons-button-prev',
                },
                on: {
                    afterInit: function () {
