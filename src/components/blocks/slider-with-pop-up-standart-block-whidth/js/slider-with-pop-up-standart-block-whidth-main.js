...
let body = qs('body'),
    header = qs('header'),
    slider = qs('.swpusbw__slider-wrap>.swiper'), //элемент слайдера
    pop_up_body = qs('.swpusbw__pop-up'),
    pop_up_overlay = qs('#overlay-galery-pop-up'),
    pop_up_close_buttton = qs('.swpusbw__pop-up-close-button'),
    pop_up_control_butttons = qs('.swpusbw__pop-up-control-buttons'),
    slider_pop_up = qs('.swpusbw__pop-up-slider-wrap>.swiper'), //элемент слайдера попап
    ...
    GALERY_SLIDER = {
        ...
        init_swiper: function () {
            ...
            this.swiper = new Swiper(slider, {
                ...
                navigation: {
                    nextEl: '.swpusbw__control-buttons-button-next',
                    prevEl: '.swpusbw__control-buttons-button-prev',
                },
                on: {
                    afterInit: function () {
    ...
    GALERY_POP_UP_SLIDER = {
        ...
        init_swiper: function () {
            this.swiper = new Swiper(slider_pop_up, {
                ...
                navigation: {
                    nextEl: '.swpusbw__pop-up-control-buttons-button-next',
                    prevEl: '.swpusbw__pop-up-control-buttons-button-prev',
                },
                on: {
                    afterInit: function () {
                        this.slides.forEach(el => add_in_observe([qs('[data-img-type]', el)])); //все картинки в слайдере добавляем на отслеживание, т.к. при цикличной прокрутке создаются дубликаты которые тоже нужно отслеживать
