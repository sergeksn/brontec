...
//abort_trigger.end_status - указывает как в случае данного срабатывания завершать промис, по умолчанию промис будет отклонён т.е. завершится неудачей
//const wait_data = {};
...
function wait(check_value, data_fo_wait, abort_trigger = {}) {
    ...
    abort_trigger = Object.assign({ end_status: 'reject' }, abort_trigger);
    ...
    return new Promise((resolve, reject) => {
        ...
        function check() {
            ...
            if (typeof abort_trigger.func === 'function' && abort_trigger.func()) {
                rem_lisener(); //удаляем слушатель для функции проверяющей виден документ или нет
                return abort_trigger.end_status === 'resolve' ? resolve('ABORT') : reject('ABORT');
