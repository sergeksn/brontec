...
export default class {
    constructor(el) {
        ...
        this.update_status(); //задаём статус видимости в зависимости от текущего состяния прозрачности

        this.el.ksn_fade = this; //записываем экземпляр объекта управления данным прозрачности в его свойства
    }

    //задаём/обновляем статус видимости в зависимости от текущего состяния прозрачности
    update_status() {
        this.sl = w.getComputedStyle(this.el); //живая коллекция стилей для нашего элемента

        this.status = this.sl.opacity && this.sl.opacity !== '0' ? 'show' : 'hide'; //устанавливаемс статус видимости в зависимости от того скрыт элемент или нет
    }
    //задаём/обновляем статус видимости в зависимости от текущего состяния прозрачности
